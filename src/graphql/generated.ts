...
/** Modulo de conteúdo para listagem de dados de aulas de ingles. */
export type Module = Node & {
  ...
  /** Coloque todos exemplos aqui nesse campos. */
  exemplos: Array<Scalars['String']>;
  ...
  /** System stage field */
  stage: Stage;
  /** Coloque aqui as dicas em Pt. */
  tipBr: Array<Scalars['String']>;
  /** Dica pra final da pagina. */
  tip_en: Array<Scalars['String']>;
  /** Titulo do Modulo. */
...
export type ModuleCreateInput = {
  ...
  exemplos?: InputMaybe<Array<Scalars['String']>>;
  slug: Scalars['String'];
  tipBr?: InputMaybe<Array<Scalars['String']>>;
  tip_en?: InputMaybe<Array<Scalars['String']>>;
...
export type ModuleManyWhereInput = {
  ...
  exemplos_contains_all?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  exemplos_contains_none?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  exemplos_contains_some?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  exemplos_not?: InputMaybe<Array<Scalars['String']>>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
  ...
  tipBr?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains *all* items provided to the filter */
  tipBr_contains_all?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  tipBr_contains_none?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  tipBr_contains_some?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  tipBr_not?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains *all* items provided to the filter and order does match */
  tip_en?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains *all* items provided to the filter */
  tip_en_contains_all?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  tip_en_contains_none?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  tip_en_contains_some?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  tip_en_not?: InputMaybe<Array<Scalars['String']>>;
  title?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
...
export enum ModuleOrderByInput {
  ...
  ExemplosAsc = 'exemplos_ASC',
  ExemplosDesc = 'exemplos_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  PublishedAtAsc = 'publishedAt_ASC',
  PublishedAtDesc = 'publishedAt_DESC',
  ...
  SlugDesc = 'slug_DESC',
  TipBrAsc = 'tipBr_ASC',
  TipBrDesc = 'tipBr_DESC',
  TipEnAsc = 'tip_en_ASC',
  TipEnDesc = 'tip_en_DESC',
  TitleAsc = 'title_ASC',
...
export type ScheduledOperationAffectedDocument = Asset | Module;
...
export type Get_Audio_FilesQueryVariables = Exact<{ [key: string]: never; }>;


export type Get_Audio_FilesQuery = { __typename?: 'Query', assets: Array<{ __typename?: 'Asset', id: string, fileName: string, url: string, audiocontent?: string | null, phrase_en?: string | null, language?: string | null }> };

export type Get_Modules_By_SlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type Get_Modules_By_SlugQuery = { __typename?: 'Query', module?: { __typename?: 'Module', description?: string | null, exemplos: Array<string>, id: string, slug: string, tipBr: Array<string>, tip_en: Array<string>, title?: string | null } | null };

export type Get_Modules_EnglishQueryVariables = Exact<{ [key: string]: never; }>;


export type Get_Modules_EnglishQuery = { __typename?: 'Query', modules: Array<{ __typename?: 'Module', id: string, slug: string, title?: string | null, description?: string | null, exemplos: Array<string>, tipBr: Array<string>, tip_en: Array<string> }> };


export const Get_Audio_FilesDocument = gql`
    query GET_AUDIO_FILES {
  assets {
    id
    fileName
    url
...
/**
 * __useGet_Audio_FilesQuery__
 *
 * To run a query within a React component, call `useGet_Audio_FilesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGet_Audio_FilesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGet_Audio_FilesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGet_Audio_FilesQuery(baseOptions?: Apollo.QueryHookOptions<Get_Audio_FilesQuery, Get_Audio_FilesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Get_Audio_FilesQuery, Get_Audio_FilesQueryVariables>(Get_Audio_FilesDocument, options);
      }
export function useGet_Audio_FilesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Get_Audio_FilesQuery, Get_Audio_FilesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Get_Audio_FilesQuery, Get_Audio_FilesQueryVariables>(Get_Audio_FilesDocument, options);
        }
export type Get_Audio_FilesQueryHookResult = ReturnType<typeof useGet_Audio_FilesQuery>;
export type Get_Audio_FilesLazyQueryHookResult = ReturnType<typeof useGet_Audio_FilesLazyQuery>;
export type Get_Audio_FilesQueryResult = Apollo.QueryResult<Get_Audio_FilesQuery, Get_Audio_FilesQueryVariables>;
export const Get_Modules_By_SlugDocument = gql`
    query GET_MODULES_BY_SLUG($slug: String) {
...
/**
 * __useGet_Modules_By_SlugQuery__
 *
 * To run a query within a React component, call `useGet_Modules_By_SlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGet_Modules_By_SlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGet_Modules_By_SlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGet_Modules_By_SlugQuery(baseOptions?: Apollo.QueryHookOptions<Get_Modules_By_SlugQuery, Get_Modules_By_SlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Get_Modules_By_SlugQuery, Get_Modules_By_SlugQueryVariables>(Get_Modules_By_SlugDocument, options);
      }
export function useGet_Modules_By_SlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Get_Modules_By_SlugQuery, Get_Modules_By_SlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Get_Modules_By_SlugQuery, Get_Modules_By_SlugQueryVariables>(Get_Modules_By_SlugDocument, options);
        }
export type Get_Modules_By_SlugQueryHookResult = ReturnType<typeof useGet_Modules_By_SlugQuery>;
export type Get_Modules_By_SlugLazyQueryHookResult = ReturnType<typeof useGet_Modules_By_SlugLazyQuery>;
export type Get_Modules_By_SlugQueryResult = Apollo.QueryResult<Get_Modules_By_SlugQuery, Get_Modules_By_SlugQueryVariables>;
export const Get_Modules_EnglishDocument = gql`
    query GET_MODULES_ENGLISH {
  modules {
    id
    slug
    title
...
/**
 * __useGet_Modules_EnglishQuery__
 *
 * To run a query within a React component, call `useGet_Modules_EnglishQuery` and pass it any options that fit your needs.
 * When your component renders, `useGet_Modules_EnglishQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGet_Modules_EnglishQuery(baseOptions?: Apollo.QueryHookOptions<Get_Modules_EnglishQuery, Get_Modules_EnglishQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Get_Modules_EnglishQuery, Get_Modules_EnglishQueryVariables>(Get_Modules_EnglishDocument, options);
      }
export function useGet_Modules_EnglishLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Get_Modules_EnglishQuery, Get_Modules_EnglishQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Get_Modules_EnglishQuery, Get_Modules_EnglishQueryVariables>(Get_Modules_EnglishDocument, options);
        }
export type Get_Modules_EnglishQueryHookResult = ReturnType<typeof useGet_Modules_EnglishQuery>;
export type Get_Modules_EnglishLazyQueryHookResult = ReturnType<typeof useGet_Modules_EnglishLazyQuery>;
export type Get_Modules_EnglishQueryResult = Apollo.QueryResult<Get_Modules_EnglishQuery, Get_Modules_EnglishQueryVariables>;